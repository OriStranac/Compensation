table 50100 "Compensation Line"
{
    DataClassification = ToBeClassified;

    fields
    {
        field(1; "Compensation No."; Code[20])
        {
        ...
        field(5; "Document No."; Code[20])
        {
            ...
            trigger OnLookup()
            var
                CompensationHeader: Record "Compensation Header";
                CustomerLedgerEntry: Record "Cust. Ledger Entry";
                VendorLedgerEntry: Record "Vendor Ledger Entry";
            begin
                CompensationHeader.Get("Compensation No.");
                case Enum of
                    Enum::Customer:
                        begin
                            CustomerLedgerEntry.SetRange("Customer No.", CompensationHeader."Cust No.");
                            CustomerLedgerEntry.SetRange("Document Type", "Document Type");
                            if page.RunModal(0, CustomerLedgerEntry) = Action::LookupOK then
                                Validate("Document No.", CustomerLedgerEntry."Document No.");
                        end;

                    Enum::Vendor:
                        begin
                            VendorLedgerEntry.SetRange("Vendor No.", CompensationHeader."Cust No.");
